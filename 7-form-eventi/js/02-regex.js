/*
    Spesso JS viene usato per validare i form, ovvero per assicurarci che l'utonto scriva informazioni nella maniera giusta o del tipo corretto all'interno degli input.
...
// /[a-z]{6,}/ così matcherà anche se mettiamo numeri e caratteri speciali, fintanto che ci siano almeno sei lettere minuscole all'interno. Abbiamo bisogno di inserire ^ all'inizio per dire che il pattern deve essere all'inizio e $ alla fine per dire che il pattern deve essere l'ultima parte scritta nel campo
const pattern = /^[a-z]{6,}$/;
